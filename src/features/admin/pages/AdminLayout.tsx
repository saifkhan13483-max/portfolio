    ...
    <div className="flex min-h-screen w-full bg-[hsl(242,30%,97.5%)]">
      ...
      >
        ...
        <div className="flex items-center gap-2.5 px-4 py-4 border-b border-[hsl(234,22%,16%)]">
          <div
            className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center flex-shrink-0 shadow-md"
            style={{ boxShadow: "0 0 0 1px rgba(37,69,230,0.4), 0 4px 12px rgba(37,69,230,0.3)" }}
          >
                ...
                >
                  <item.icon
                    className={cn(
                      ...
                      isActive ? "text-white" : "text-[hsl(234,15%,50%)] group-hover:text-white"
                    )}
                  />
        ...
        <div className="p-2 border-t border-[hsl(234,22%,16%)] space-y-1">
          <a href="/" target="_blank" rel="noopener noreferrer">
            <div className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-[hsl(234,15%,50%)] hover:text-white hover:bg-[hsl(234,22%,16%)] transition-colors cursor-pointer">

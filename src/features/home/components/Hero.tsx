...
function NeuralNetwork() {
  ...
  return (
    <canvas
      ref={canvasRef}
      className="absolute inset-0 w-full h-full pointer-events-none opacity-95 blur-[1.5px]"
      aria-hidden="true"
    />
  );
}
      ...
      <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            >
              Saif Khan — senior fullstack developer — brings{" "}
              <strong className="text-foreground font-semibold">7+ years of hands-on experience</strong>{" "}

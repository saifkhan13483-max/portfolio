  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative w-full overflow-hidden">
        <div className="relative w-full flex flex-col min-h-[380px] sm:min-h-[460px] lg:min-h-[540px]">
          ...
          <div className="relative z-10 flex flex-col justify-end h-full px-4 sm:px-8 lg:px-14 xl:px-20 pt-6 pb-8 sm:pb-12 lg:pb-14 max-w-7xl 2xl:max-w-[1600px] mx-auto w-full">
            ...
            <m.div {...fadeIn(0.05)} className="mb-5 sm:mb-7">
              <Link href="/portfolio">
                <button
                  className="inline-flex items-center gap-1.5 text-white/50 hover:text-white/90 transition-colors duration-200 text-xs font-medium group"
                ...
                >
                  ...
                  <span className="text-white/60 truncate max-w-[160px] sm:max-w-xs">{project.title}</span>
                </button>
              </Link>
            </m.div>

            {/* Status badges */}
            <m.div {...fadeUp(0.12)} className="flex flex-wrap gap-2 mb-4 sm:mb-5">
            ...
            <m.h1
              {...fadeUp(0.2)}
              className="font-display font-bold text-white leading-[1.08] tracking-tight mb-3 sm:mb-4"
            ...
            <m.p
              {...fadeUp(0.28)}
              className="text-sm sm:text-base lg:text-[1.05rem] text-white/55 leading-relaxed max-w-2xl mb-6 sm:mb-7"
            >
              {project.description}
            </m.p>
            ...
            <m.div {...fadeUp(0.35)} className="flex flex-wrap gap-2.5 sm:gap-3">
              {project.projectUrl && (
                <a href={project.projectUrl} target="_blank" rel="noopener noreferrer" data-testid="button-live-demo">
                  <Button
                    size="lg"
                    className="h-11 sm:h-12 px-5 sm:px-7 rounded-xl text-sm font-bold bg-primary hover:bg-primary/90 shadow-lg shadow-primary/40 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
                  >
              ...
              {project.githubUrl && (
                <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" data-testid="button-github-repo">
                  <Button
                    size="lg"
                    className="h-11 sm:h-12 px-5 sm:px-7 rounded-xl text-sm font-bold border border-white/20 text-white hover:bg-white/12 hover:border-white/35 bg-white/8 backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
                  >
      ...
      <div className="lg:hidden px-4 sm:px-8 pt-5 pb-2">
        <button
          ...
          className="w-full flex items-center justify-between px-4 py-3.5 rounded-2xl border border-border bg-card shadow-sm text-sm font-semibold text-foreground transition-colors duration-200 hover:bg-muted/40"
        ...
        <AnimatePresence>
          {mobileMetaOpen && (
            ...
            >
              <div className="mt-2.5 rounded-2xl border border-border bg-card overflow-hidden shadow-sm">
                ...
                {(project.projectUrl || project.githubUrl) && (
                  <div className="p-3.5 flex flex-col gap-2.5 bg-muted/20">
                    {project.projectUrl && (
                      <a href={project.projectUrl} target="_blank" rel="noopener noreferrer">
                        <Button className="w-full h-11 rounded-xl font-bold text-sm bg-primary hover:bg-primary/90 transition-all duration-200 shadow-md shadow-primary/20">
                    ...
                    {project.githubUrl && (
                      <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                        <Button variant="outline" className="w-full h-11 rounded-xl font-bold text-sm transition-all duration-200">
      ...
      {/* ═══════════════════════════════════════════════════════
          BODY — main content + desktop sidebar
      ═══════════════════════════════════════════════════════ */}
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 xl:gap-16">
          ...
          <main className="flex-1 min-w-0">
              ...
              <div className="space-y-4 sm:space-y-5">
                {paragraphs.map((para, i) => (
                  <m.p
                    ...
                    className="text-[0.9375rem] sm:text-base text-muted-foreground leading-[1.85] sm:leading-[1.9]"
                  >
                    {para}
                  </m.p>
                ))}
            ...
            >
              ...
              <div className="absolute inset-0 border border-primary/15 rounded-2xl sm:rounded-3xl" />
              ...
              <div className="relative p-5 sm:p-8 lg:p-10">
                <div className="flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-10">
                  <div className="flex-1 min-w-0">
                    <div className="inline-flex items-center gap-1.5 bg-primary/10 text-primary text-xs font-black uppercase tracking-[0.18em] px-2.5 py-1 rounded-full mb-3">
                  ...
                  <div className="flex flex-row sm:flex-col gap-2.5 shrink-0">
                    <Link href="/contact">
                      <Button
                        size="lg"
                        className="h-11 rounded-xl font-bold text-sm bg-primary hover:bg-primary/90 shadow-md shadow-primary/25 px-5 sm:w-44 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
                    ...
                    <Link href="/portfolio">
                      <Button
                        variant="outline"
                        size="lg"
                        className="h-11 rounded-xl font-bold text-sm border-border hover:border-primary/30 hover:bg-muted/40 px-5 sm:w-44 transition-all duration-200"
          ...
          <aside className="hidden lg:block w-[272px] xl:w-[296px] shrink-0">
            ...
            >
                  ...
                  <div className="p-4 flex flex-col gap-2.5 bg-muted/20">
                    {project.projectUrl && (
                      <a href={project.projectUrl} target="_blank" rel="noopener noreferrer" data-testid="button-live-demo-sidebar">
                        <Button size="lg" className="w-full h-11 rounded-xl text-sm font-bold bg-primary hover:bg-primary/90 shadow-md shadow-primary/20 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0">
                    ...
                    {project.githubUrl && (
                      <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" data-testid="button-github-sidebar">
                        <Button variant="outline" size="lg" className="w-full h-11 rounded-xl text-sm font-bold border-border hover:border-primary/40 hover:bg-muted/50 transition-all duration-200">
              ...
              <div className="rounded-2xl border border-primary/15 bg-gradient-to-br from-primary/8 via-primary/4 to-transparent p-5 overflow-hidden relative">
                ...
                <Link href="/contact">
                  <Button className="w-full h-10 rounded-xl text-xs font-bold bg-primary hover:bg-primary/90 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0" data-testid="button-sidebar-contact">
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3.5">
      ...
      <div className="min-w-0 flex-1">
        <p className="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground leading-none mb-1">{label}</p>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-5 sm:mb-6 pb-4 border-b border-border/60">
        <div className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center border border-primary/15 shrink-0">
          {icon}
        </div>
        <h2 className="text-[1.05rem] sm:text-lg lg:text-xl font-display font-bold text-foreground tracking-tight leading-snug">{title}</h2>
      </div>
      {children}
    </m.section>
  );
...
function TechChip({ label }: { label: string }) {
  return (
    <div className="group inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 sm:py-2.5 bg-card border border-border rounded-xl hover:border-primary/40 hover:bg-primary/5 hover:shadow-sm transition-all duration-200 cursor-default min-h-[40px]">
      <div className="w-4 h-4 rounded-md bg-primary/10 flex items-center justify-center shrink-0 group-hover:bg-primary/20 transition-colors duration-200">
